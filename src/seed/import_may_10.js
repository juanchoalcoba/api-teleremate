 ...
 * import_may_10.js
 *
 * Importa los artículos de catalogo3.json a MongoDB como artículos "remate"
 * para el Domingo 10 de Mayo.
 *
 * ESTRATEGIA:
 *   1. NO limpia ni borra artículos existentes.
 *   2. Guarda el número original en `auctionLot`.
 *
 * USO: node src/seed/import_may_10.js
 */
...
// Definición exclusiva de la importación del Domingo 10 de Mayo
const CATALOGS = [
  {
    file: "catalogo3.json",
...
async function importMay10() {
  ...
  console.log('🚀 Iniciando importación SEGURA (sin borrar) para Domingo 10 de Mayo...');
  ...
  console.log(`   📊 Total artículos del 10 de Mayo en BD: ${finalCount}`);
  console.log("-------------------------------------------\n");
